...
#For the expanded clones of the pooled patient data, we find the distribution of CDR3a sequences as well as the length of the CDR3a sequences
...
final800<-final700[rep(row.names(final700), final700$value), 1:3]#Every CDR3a sequence that happens more then once gets a new row



write.csv(final800, "List of CDR3a_Pooled.csv")#Gives the required output in csv form
