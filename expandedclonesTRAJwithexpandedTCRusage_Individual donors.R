...
#For the expanded clones, we calculate the fraction of different TRAJ and plot them as a heatmap with x-axis giving the different patients at stimulated and un-stimulated conditions and the y-axis giving the fractions of TRAJ expression 
