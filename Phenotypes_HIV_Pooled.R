...
#For the clones, we pool together the data for all the patients at stimulatd and un-stimulated conditions
...
write.csv(new_data5, " GATA3_Expanded cells_Pooled.csv")
write.csv(new_data6," FOXP3_Expanded cells_Pooled.csv")
write.csv(new_data7," GZMB_Expanded Cells_Pooled.csv")
write.csv(new_data8," IFNG_Expanded cells_Pooled.csv")
write.csv(new_data9, " IL10_Expanded cells_Pooled.csv")
write.csv(new_data10," IL12A_Expanded cells_Pooled.csv")
write.csv(new_data11, " IL17A_Expanded cells_Pooled.csv")
write.csv(new_data12, " PRF1_Expanded cells_Pooled.csv")
write.csv(new_data13, " RORC_Expanded cells_Pooled.csv")
write.csv(new_data14," TBET_Expanded cells_Pooled.csv")
write.csv(new_data15, "TGFB1_Expanded cells_Pooled.csv")
write.csv(new_data16, " TNF_Expanded cells_Pooled.csv")
write.csv(new_data17, " BCL6_Expanded cells_Pooled.csv")
write.csv(new_data18, " RUNX1_Expanded cells_Pooled.csv")
write.csv(new_data19, " RUNX3_Expanded cells_Pooled.csv")
